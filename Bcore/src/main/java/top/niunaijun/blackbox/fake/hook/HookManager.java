...
import top.niunaijun.blackbox.fake.service.ActivityThreadIdentityProxy;
import top.niunaijun.blackbox.fake.service.ApplicationAttachSeccompProxy;
...
public class HookManager {
    ...
    public void init() {
        if (BlackBoxCore.get().isBlackProcess() || BlackBoxCore.get().isServerProcess()) {
            ...
            addInjector(new ApplicationAttachSeccompProxy());
            addInjector(new IPackageManagerProxy());
            addInjector(new ServiceManagerProxy());
